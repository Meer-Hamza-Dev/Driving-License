...
Widget appField({
  ...
  return AppTextFied(
    ...
    borderColor: border ?? AppColors.grey_color,
    borderColor1: border ?? AppColors.grey_color,
    hint: hint ?? "",
    hintColor: hintColor ?? AppColors.description_color,
    textInputType: textInputType ?? TextInputType.name,
    textInputAction: textInputAction ?? TextInputAction.next,
    hintSize: hintSize ?? 15,
    isSuffix: isSuffix,
    controller: controller,
    borderColor2: border ?? AppColors.primaryColor,
    maxLines: max ?? 1,
  );
}
