  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: MainAppBar(
          title: ConstantStrings.VehcletypeText,
          size: 16,
        ),
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              AppText(
                title: ConstantStrings.VehclebrndText,
                fontWeight: FontWeight.w600,
                size: 14,
              ),
              SizedBox(
              ...
              AppText(
                title: ConstantStrings.VehcleNmeText,
                fontWeight: FontWeight.w600,
                size: 14,
              ),
              SizedBox(
              ...
              AppText(
                title: ConstantStrings.DescriptionText,
                fontWeight: FontWeight.w600,
                size: 14,
              ),
              SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15),
                        AppText(
                          title: ConstantStrings.UplodImageText,
                          size: 14,
              ...
              AppText(
                title: ConstantStrings.SaftyRatngText,
                fontWeight: FontWeight.w600,
                size: 14,
              ),
              SizedBox(
              ...
              AppText(
                title: ConstantStrings.AirbagsText,
                fontWeight: FontWeight.w600,
                size: 14,
              ),
              SizedBox(
              ...
              AppButton(
                buttonName: ConstantStrings.NextText,
                onTap: () {
                  Get.toNamed(Routes.trainerInfoRoute);
                },
              ),
            ],
          ),
